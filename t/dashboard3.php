...
<body>
    ...
    <div class="modal fade " id="setting_workspace" tabindex="-1" role="dialog" aria-modal="false">
        <div class="modal-dialog modal-dialog-vertical" role="document" style="width: 100%; height:50%; overflow:hidden; max-width: none">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <div class="col-auto">
                                ...
                                <a href="https://adv.globres.io" class="dropdown-ellipses dropdown-toggle" style="float:right">
                        ...
                        <div class="card-footer card-footer-boxed">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <!-- Icon -->
                                    <a class="btn btn-sm btn-outline-primary" href="#setting_workspace" data-toggle="modal">Setting</a>
                        ...
                        <div class="card-footer card-footer-boxed">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <!-- Icon -->
                                    <a class="btn btn-sm btn-outline-primary" href="">Setting</a>
